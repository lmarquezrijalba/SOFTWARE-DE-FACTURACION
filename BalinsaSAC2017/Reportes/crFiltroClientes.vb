...
Public Class crFiltroClientes
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "BalinsaSAC.crFiltroClientes.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrFiltroClientes
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crFiltroClientes = New crFiltroClientes()
        rpt.Site = Me.Site
        Return rpt
    End Function
