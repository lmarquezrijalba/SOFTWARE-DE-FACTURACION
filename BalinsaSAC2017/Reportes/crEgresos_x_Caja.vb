...
Public Class crEgresos_x_Caja
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "BalinsaSAC.crEgresos_x_Caja.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrEgresos_x_Caja
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crEgresos_x_Caja = New crEgresos_x_Caja()
        rpt.Site = Me.Site
        Return rpt
    End Function
