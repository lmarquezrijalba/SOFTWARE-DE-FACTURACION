...
Public Class crFiltroClientes2
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "BalinsaSAC.crFiltroClientes2.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrFiltroClientes2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crFiltroClientes2 = New crFiltroClientes2()
        rpt.Site = Me.Site
        Return rpt
    End Function
