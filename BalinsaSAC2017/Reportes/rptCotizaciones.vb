...
Public Class rptCotizaciones
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "BalinsaSAC.rptCotizaciones.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_IDCot() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedrptCotizaciones
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptCotizaciones = New rptCotizaciones()
        rpt.Site = Me.Site
        Return rpt
    End Function
